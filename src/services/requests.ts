import { ApiDeleteUser, ApiGetUser, ApiSingIn, ApiSingUp, ApiUpdateUser } from "../@types/Auth"
...
export const signIn = async (email: string, password: string)=> {
    return await api<ApiSingIn>({
        endpoint: 'auth/singin', method: 'POST', data: { email, password }, withAuth: false
    })
}
...
export const updateUer = async (name: string, email: string)=> {
